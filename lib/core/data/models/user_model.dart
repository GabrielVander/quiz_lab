...
class UserModel extends Equatable {
  ...
  factory UserModel.fromAppwriteModel(User appwriteModel) {
    return UserModel(
      ...
      $createdAt:
          appwriteModel.$createdAt != 'null' ? appwriteModel.$createdAt : '',
      $updatedAt:
          appwriteModel.$updatedAt != 'null' ? appwriteModel.$updatedAt : '',
      name: appwriteModel.name != 'null' ? appwriteModel.name : '',
      registration: appwriteModel.registration != 'null'
          ? appwriteModel.registration
          : '',
      status: appwriteModel.status,
      passwordUpdate: appwriteModel.passwordUpdate != 'null'
          ? appwriteModel.passwordUpdate
          : '',
