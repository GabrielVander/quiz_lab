...
class MainBottomNavBar extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bottomNavigationState = useBlocBuilder<BottomNavigationCubit, BottomNavigationState>(
      bottomNavigationCubit,
      buildWhen: (current) => buildWhen.contains(current.runtimeType),
    );

    final currentIndex = bottomNavigationState is BottomNavigationIndexChangedState
    ...
    return HookBuilder(
      builder: (context) => BottomNavigationBar(
        ...
        onTap: (int newIndex) => bottomNavigationCubit.transitionTo(newIndex: newIndex),
        items: [
